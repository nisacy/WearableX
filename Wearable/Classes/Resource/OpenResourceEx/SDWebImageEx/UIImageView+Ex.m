...
- (void)setImageWithPreviousCachedImageWithURL:(NSURL *)url andPlaceholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletionBlock)completedBlock{
...
- (void)addActivityIndicatorWithStyle:(UIActivityIndicatorViewStyle) activityStyle {
    ...
    if (!self.activityIndicator) {
        ...
        float x = (80 - activityIndicatorBounds.size.width) / 2.0;
        float y = (80 - activityIndicatorBounds.size.height) / 2.0;

...
+ (void)move:(UIView *)view toPosition:(CGPoint)origin Duration:(float)duration completion:(void (^)())complete
{
    [UIView animateWithDuration:duration animations:^{
        view.center = CGPointMake(origin.x + W(view) / 2, origin.y + H(view) / 2);
